for is_sorted in "True" "False";do
    for i in 10,30,100 30,60,70 70,90,40; do
...
# Compare
rm results/scenario_gender__subseq_smpl_strategy_cpc_v2.txt
python -m embeddings_validation \
    --conf conf/cpc_v2_embeddings_validation_short.hocon --workers 10 --total_cpu_count 20 --local_scheduler \
    --conf_extra \
      'report_file: "../results/scenario_gender__subseq_smpl_strategy_cpc_v2.txt",
