...
python ../../pl_train_module.py trainer.max_epochs=1 --conf conf/cpc_params_for_finetuning.hocon

# Fine tune the CPC model in supervised mode and save scores to the file
python ../../pl_fit_target.py trainer.max_epochs=1 --conf conf/pl_fit_finetuning_cpc.hocon

# # Fine tune the RTD model in supervised mode and save scores to the file
python ../../pl_fit_target.py trainer.max_epochs=1 --conf conf/pl_fit_finetuning_rtd.hocon
