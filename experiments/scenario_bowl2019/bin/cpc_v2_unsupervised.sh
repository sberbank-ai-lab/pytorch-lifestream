...
python ../../pl_train_module.py trainer.max_epochs=2 --conf conf/agg_features_params.hocon
python ../../pl_inference.py --conf conf/agg_features_params.hocon

# Train the Contrastive Predictive Coding (CPC_V2) model; inference
python ../../pl_train_module.py trainer.max_epochs=2 --conf conf/cpc_v2_params.hocon
